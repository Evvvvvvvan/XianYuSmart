...
面向多租户场景的闲鱼虚拟商品运营系统，支持固定内容与卡密两种交付模式，聚焦自动发货、客服自动化、订单评价、商品运营和异常待办，在有限服务器资源下保持数据隔离、可恢复、可追踪和易运维。

当前版本：`1.0.0`

[核心价值](#核心价值) · [能力范围](#能力范围) · [功能入口与使用顺序](#功能入口与使用顺序) · [业务流程](#业务流程) · [镜像部署](#镜像部署) · [快速启动](#快速启动) · [配置说明](#配置说明) · [开发构建](#开发构建) · [日常运维](#日常运维) · [许可证与免责声明](#许可证与免责声明)
