...
# pom 资源声明会从 vue-code/src/data 打包 china-division.json，需一并复制
...
# 从构建阶段复制 JAR
COPY --from=backend-build --chown=xianyusmart:xianyusmart /app/target/xianyusmart-2.0.2.jar app.jar
